...
<qgis version="2.3.0-Master" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <edittypes>
    <edittype labelontop="0" editable="0" name="local_id"/>
    <edittype labelontop="0" editable="0" name="id"/>
    <edittype labelontop="0" editable="0" name="created"/>
    <edittype labelontop="0" editable="0" name="request_id"/>
    <edittype labelontop="0" editable="0" name="safety"/>
    <edittype labelontop="0" editable="0" name="team_id"/>
    <edittype labelontop="0" editable="0" name="number"/>
    <edittype labelontop="0" editable="0" name="date"/>
    <edittype labelontop="0" editable="0" name="gid_catasto"/>
  </edittypes>
  <editform></editform>
