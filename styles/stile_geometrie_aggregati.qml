...
<qgis version="2.3.0-Master" minimumScale="0" maximumScale="3000" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <customproperties>
    ...
    <property key="loadedByGeosismaRTPlugin" value="VLID_GEOM_FAB10K"/>
  </customproperties>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="0" name="fid_1"/>
    ...
    <edittype labelontop="0" editable="0" name="cod_com"/>
    <edittype labelontop="0" editable="0" name="fid_2"/>
    <edittype labelontop="0" editable="0" name="area_1"/>
    <edittype labelontop="0" editable="0" name="perimeter"/>
    <edittype labelontop="0" editable="0" name="comune_"/>
    <edittype labelontop="0" editable="0" name="comune_id"/>
    <edittype labelontop="0" editable="0" name="codistat91"/>
    <edittype labelontop="0" editable="0" name="provincia"/>
    <edittype labelontop="0" editable="0" name="nomemai"/>
    <edittype labelontop="0" editable="0" name="nomemin"/>
  </edittypes>
  <editform></editform>
