...
<qgis version="2.3.0-Master" minimumScale="-4.65661e-10" maximumScale="100000" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="esito" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="A" label="A"/>
      <category symbol="1" value="B" label="B"/>
      <category symbol="2" value="C" label="C"/>
      <category symbol="3" value="D" label="D"/>
      <category symbol="4" value="E" label="E"/>
      <category symbol="5" value="F" label="F"/>
      <category symbol="6" value="" label="Senza esito"/>
    </categories>
    <symbols>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color" v="0,136,0,255"/>
          <prop k="color_border" v="46,93,0,255"/>
      ...
      <symbol alpha="1" type="fill" name="1">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color_border" v="162,162,0,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" type="fill" name="2">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="border_width_unit" v="MM"/>
          <prop k="color" v="255,153,0,255"/>
          <prop k="color_border" v="136,91,0,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" type="fill" name="3">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color_border" v="86,86,86,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" type="fill" name="4">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color_border" v="140,0,0,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" type="fill" name="5">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="border_width_unit" v="MM"/>
          <prop k="color" v="153,153,255,255"/>
          <prop k="color_border" v="120,120,180,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
  ...
  <customproperties>
    ...
    <property key="loadedByGeosismaRTPlugin" value="VLID_GEOM_SOPRALLUOGHI"/>
  </customproperties>
  ...
  <attributeactions>
    <actionsetting action="qgis.utils.plugins['postgres91plusauditor'].audit('sopralluoghi20130510125423181',[% $id %])" capture="0" type="1" name="History audit"/>
  </attributeactions>
</qgis>
